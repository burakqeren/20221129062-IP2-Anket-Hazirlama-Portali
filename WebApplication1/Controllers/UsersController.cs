...
namespace WebApplication1.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            var identityResult = await _userManager.CreateAsync(new() { UserName = dto.UserName, Email = dto.Email, PhoneNumber = dto.PhoneNumber }, dto.Password);
        ...
        private string GenerateJWT(List<Claim> claims)           // claimsleri kullanarak token oluşturur
        {
